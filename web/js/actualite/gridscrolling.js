    ...
    var methods = {
        ...
        setPositions : function (matrix, options) {
            ...
            $(matrix).each(function (pos) {
                ...
                $(this).each(function (subPos) {
                    ...
                    if(pos > 0) {
                        ...
                        if(!navigator.userAgent.match(/(iPhone|Android|BlackBerry)/i)){
                        	left = ( subPos * $(this).outerWidth(true) + 30*count);
                        }
                        else {
                        	if (count > 0 && count < 3) {
                            	left = ( subPos * $(this).outerWidth(true) + 45*count);
    						}
                            else {
                            	left = ( subPos * $(this).outerWidth(true));
                            }
                        }
						...
						if(count < 3) {
							heightArray[count] = heightArray[count] + $(this).outerHeight(true) 
							count = count + 1;
						}
                        ...
                        heightArray.push($(this).outerHeight(true) + 50);
                ...
                staticInfo.firstRun = true;
         
            });
			
			$("#lb-list").css("height",(Math.max.apply(Math,heightArray)));
